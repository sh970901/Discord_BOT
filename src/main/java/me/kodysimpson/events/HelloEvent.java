...
//    public static String classMesaage(String classArr[]){
...
//            }
//        }
//        message+="\n위키 작성 후 작성 완료했다는 메시지 꼭 남겨주세요!!(링크 첨부)";
//        return message;
//    }
//
...
////        String message_first = "오늘 위키 작성 부탁드립니다!\uD83D\uDE42\n";
////        String message_end= "위키 작성 후 작성 완료했다는 메시지 꼭 남겨주세요!!(링크 첨부)";
//        String message1 = classMesaage(class1)+"\n";
//        String message2 = classMesaage(class2)+"\n";
//        String message3 = classMesaage(class3)+"\n";
